(function(){
    ...
    // ★★★ Expanded Text Detection (English + Bengali + Chinese) ★★★
    ...
    function isVisible(el){
        ...
        try{ return !!(el.offsetWidth || el.offsetHeight || el.getClientRects().length); }catch(e){ return true; }
    }
    ...
    function sendResult(messages){
        try{
            ...
            try{ window.__xExtRunning = false; }catch(e){} // Reset flag for next run
        }
    }
    ...
    function loadHistory(cb){
        ...
        function step(){
            ...
            expandOnce(); // Keep expanding as we scroll
    ...
    function sweepDown(cb){
        ...
        function step(){
            ...
            expandOnce(); // Expand any new "Show more" buttons revealed by scrolling
            var total = 0;
